                    ...
                    <div class="row">
                        <div class="span3">
                            ...
                            <?php 
                            	if ($answer_pos==0)
                            	{
                            		echo '<a href="#">'.urldecode($answer["user_name"]).'</a><br />';
                            	}
                            	echo '<a href="#">'.urldecode($opt2["user_name"]).'</a><br />';
								if ($answer_pos==1)
                            	{
                            		echo '<a href="#">'.urldecode($answer["user_name"]).'</a><br />';
                            	}
                            	echo '<a href="#">'.urldecode($opt3["user_name"]).'</a><br />';
								if ($answer_pos==2)
                            	{
                            		echo '<a href="#">'.urldecode($answer["user_name"]).'</a><br />';
                            	}	
                            	echo '<a href="#">'.urldecode($opt4["user_name"]).'</a><br />';
								if ($answer_pos==3)
                            	{
                            		echo '<a href="#">'.urldecode($answer["user_name"]).'</a><br />';
                            	}
